...
def parse_args():
    ...
    parser.add_argument('--resume', help="resume training from checkpoint", required=False,
                        default="NA", type=str)
    parser.add_argument("--opts", help="Command line options to overwrite configs", default=[],
...
def main():
    ...
    if cfg.TRAIN.OPTIMIZER.type == "adadelta":
        ...
        optimizer = optim.SGD(trainable_params, lr=cfg.TRAIN.initial_lr,
    ...
    if cfg.TRAIN.lr_scheduler == "step_down":
        scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer,
                                                         milestones=cfg.TRAIN.step_down_on_epoch,

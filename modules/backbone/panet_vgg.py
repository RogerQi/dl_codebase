"""
Note: accessed from https://github.com/kaixin96/PANet/blob/master/models/vgg.py
...
class panet_vgg(backbone_base):
    """
    Encoder for few shot segmentation used in PANet: https://arxiv.org/abs/1908.06391
    ...
    def __init__(self, cfg, in_channels=3):
        super(panet_vgg, self).__init__(cfg)
